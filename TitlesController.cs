...
namespace HR3.Controllers
{
    public class TitlesController : Controller
    {
        ...
        public TitlesController(HRDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,position")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,position")] Title title)
        {
            if (id != title.Id)
            {
                return NotFound();
